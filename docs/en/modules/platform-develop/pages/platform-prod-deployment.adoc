...
The Registry Platform supports two deployment modes: `*development*` and `*production*`.
...
The Registry Platform is built based on the *DevSecOps* secure software development methodology.
