...
The subsystem that provides management for users, user management, authentication/authorization settings, signle sign-on (SSO), and external _Identity Providers_ integration in the Digital Services Development Platform.
