= Classes of IT systems that can be built on Digital Services Development Platform
include::DSDP:ROOT:partial$templates/document-attributes/default-set-en.adoc[]

include::DSDP:ROOT:partial$admonitions/language-en.adoc[]

== What is the _Digital Services Development Platform_?

The *_Digital Services Development Platform_* is a flexible, secure, low-code digital backend for building various IT systems. Let's elaborate:

* *Flexible*: The Digital Services Development Platform is cloud-agnostic, meaning it can function effectively on different cloud services without relying on a specific environment.
